    ...
    <div className='flex flex-col justify-center items-center desktop:flex-row desktop:space-x-48'>
      {
        authorities.map((authority, index)=>(
          ...
          <div className="w-full pt-5 flex items-center justify-center">
            <img src={authority.photo} className=" w-64 rounded-lg desktop:transition-all desktop:duration-300 desktop:cursor-pointer desktop:filter desktop:grayscale hover:grayscale-0" alt={`${authority.position} Photo`} />
          </div>
